...
public class PlayerStateMachine : MonoBehaviour
{
    ...
    private InputAction hatThrowStatic;
    private InputAction hatThrowDynamic;
    ...
    private void Awake()
    {
        ...
        hatThrowStatic = control.player.HatThrowStatic;
        hatThrowDynamic = control.player.HatThrowDynamic;

        shoot = control.player.Shoot;
    ...
    private void OnEnable()
    {
        ...
        slide.Enable();
        direction.Enable();
        hatThrowStatic.Enable();
        hatThrowDynamic.Enable();
        shoot.Enable();
        //grapple.Enable();
        //grappleHold.Enable();
    }
    ...
    private void OnDisable()
    {
        ...
        slide.Disable();
        direction.Disable();
        hatThrowStatic.Disable();
        hatThrowDynamic.Disable();
        shoot.Disable();
        //grapple.Disable();
        //grappleHold.Disable();
    }
    ...
    public void ThrowHatStatic()
    {
        if (hatThrowStatic.WasPerformedThisFrame())
        {
            hat.ThrowStatic();
        }
    }

    public void ThrowHatDynamic()
    {
        if (hatThrowDynamic.WasPerformedThisFrame())
        {
            hat.ThrowDynamic();
        }
    }
